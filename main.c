...
static nrf_saadc_value_t voltage;
int button_value;
...
#define OUR_CHAR_TIMER_INTERVAL     APP_TIMER_TICKS(1) // 1000 ms intervals
...
static void application_timers_start(void)
{
    ...
    app_timer_start(m_our_char_timer_id_3, APP_TIMER_TICKS(200), NULL);          
...
static void ble_stack_init(void)
{
    ...
    NRF_SDH_BLE_OBSERVER(m_ble_observer_2, APP_BLE_OBSERVER_PRIO, ble_evt_handler, &m_our_service);        //ble_eventlerini gözlemliyor
...
static void advertising_init(void)
{
    ...
    //init.config.ble_adv_fast_timeout  = APP_ADV_DURATION; //SÜREKLÝ ADVCERTISING YAPMASINI ÝSTÝYORSAK DEVRE DIÞI BIRAKILMALI
